...
const WARRANTY_ITEMS = [
  ...
  { icon: "PhoneCall", title: "Поддержка 24/7", desc: "Техническая консультация по телефону в любое время" },
];
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <img src={WORKSHOP_IMG} alt="Мастерская АгроСервис" className="w-full object-cover" style={{ height: "520px", filter: "brightness(0.85)" }} />
